...
class _MyAppState extends State<MyApp> {
  ...
  String OptionsVal1;
  List India = [
    'Dubai','Brazil','Canada','America'
  ];
  bool disabledropdown2 = true;
  String OptionsVal2;
  List Dubai = [
    'Brazil','Canada','America'
  ];
  String OptionsVal3;
  List Brazil = [
    'Canada','America'
                                ...
                                Padding(
                                  ...
                                  child: SizedBox(height: 30,width:180,
                                    child: DropdownButton(underline: SizedBox(),
                                      ...
                                      value:OptionsVal2,
                                      onChanged:disabledropdown1? null:(newValue) {
                                        setState((
                                            ) {
                                          OptionsVal2 = newValue;
                                  ...
                                  Padding(
                                    ...
                                    child: SizedBox(height: 30,width:180,
                                      child: DropdownButton(underline: SizedBox(),
                                        ...
                                        value:OptionsVal3,
                                        onChanged:disabledropdown2? null:(newValue) {
                                          setState((
                                              ) {
                                            OptionsVal3 = newValue;
                                          });
                                        },
